...
contract DeployUniswapV4 is Script, DeployCreate2Deployer, DeployPermit2 {
    ...
    function testLifeCycle(UniswapContracts memory contracts) public {
        ...
        multicallParams[1] = abi.encodeWithSelector(
            contracts.v4PositionManager.modifyLiquidities.selector, abi.encode(mintActions, mintParams), deadline
        );
